...
export default function LegalPage({
  ...
  const handleNavigate = (page: string, tab?: string) => {
    if (navigateTo) {
      ...
      const url = tab ? `/${page}?tab=${tab}` : `/${page}`;
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0e] text-zinc-100 font-sans selection:bg-red-600 flex flex-col">
      {/* Tabs */}
      <div className="bg-[#0d0d14] border-b border-zinc-900 py-3 px-4 shadow-sm">
        <div className="max-w-4xl mx-auto flex gap-2 overflow-x-auto scrollbar-none">
          <button
            onClick={() => handleTabChange('privacy')}
            className={`flex items-center gap-2 text-xs font-bold px-4 py-2.5 rounded-xl border whitespace-nowrap transition-all duration-200 ${
              activeTab === 'privacy'
      ...
      {/* Content */}
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-8 md:py-12 pb-24 md:pb-12">
        {/* PRIVACY POLICY VIEW */}
        {activeTab === 'privacy' && (
          <div className="space-y-6">
            ...
            <div className="bg-[#0d0d14] border border-zinc-900 rounded-2xl p-6 space-y-4 hover:border-red-500/20 transition-all duration-200">
            ...
            <div className="bg-[#0d0d14] border border-zinc-900 rounded-2xl p-6 space-y-3 hover:border-red-500/20 transition-all duration-200">
            ...
            <div className="bg-[#0d0d14] border border-zinc-900 rounded-2xl p-6 space-y-2 hover:border-red-500/20 transition-all duration-200">
            ...
            <div className="bg-[#0d0d14] border border-zinc-900 rounded-2xl p-6 space-y-4 hover:border-red-500/20 transition-all duration-200">
              ...
              <div className="bg-[#07070a] border border-zinc-800 rounded-xl p-4 space-y-3">
                <p className="text-xs text-zinc-400">For Privacy or details questions on this updates:</p>
        ...
        {activeTab === 'terms' && (
          <div className="space-y-6">
            ...
            <div className="bg-[#0d0d14] border border-zinc-900 rounded-2xl p-6 space-y-3 hover:border-red-500/20 transition-all duration-200">
              ...
              <div className="text-xs text-zinc-400 space-y-2 pl-1">
            ...
            <div className="bg-[#0d0d14] border border-zinc-900 rounded-2xl p-6 space-y-4 hover:border-red-500/20 transition-all duration-200">
              ...
              <div className="bg-[#07070a] border border-zinc-800 rounded-xl p-4">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#0d0d14] border border-zinc-900 rounded-2xl p-6 space-y-4 hover:border-red-500/20 transition-all duration-200">
              ...
              <div className="text-xs text-zinc-400 space-y-4 leading-relaxed">
                ...
                <div className="bg-[#07070a] border border-zinc-800 rounded-xl p-4 space-y-2">
            ...
            <div className="bg-rose-500/10 border border-rose-500/20 text-rose-400 text-[11px] font-bold p-4 rounded-xl flex items-start gap-3 leading-relaxed">
